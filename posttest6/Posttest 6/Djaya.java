...
interface Penjualan {
    static void cekStok() {
        if (Djaya.jumlahAlatMusik == 0) {
            System.out.println("Stok alat musik habis.");
        } else {
            System.out.println("Stok alat musik saat ini: " + Djaya.jumlahAlatMusik);
        }
    }

    void hargaDiskon(double diskon);
}

abstract class AlatMusik implements Penjualan {
    private String nama;
    ...
    @Override
    public void hargaDiskon(double diskon) {
        setHarga(getHarga() - (getHarga() * diskon));
        System.out.println("Harga setelah diskon: Rp" + (int) getHarga());
    }
}
        ...
        do {
            ...
            switch (pilihan) {
                ...
                case 6:
                    ...
                    break;
                default:
                    System.out.println("Pilihan tidak tersedia. Silakan pilih menu 1-6.");
            }
